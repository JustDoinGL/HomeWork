...
# Пример:
new_triangles = list(
    map(tr_symmetry, triangles, [0] * n, [1.05] * n, [1] * n, [1.05] * n))
print_polygon(triangles + new_triangles)
...
new_triangles = list(
    map(tr_symmetry, triangles, [0] * n, [3] * n, [1] * n, [3] * n))
print_polygon(triangles + new_triangles)
#print_polygon(new_triangles)
...
print_polygon(first_part[1:] + second_part)
